...
const NavBar = ({ isVisible = true }) => {
    ...
    return(
        <nav className={`fixed inset-x-0 bottom-0 z-50 h-16 bg-full-white shadow-[0_-4px_14px_rgba(15,23,42,0.12)] flex flex-row justify-around items-center transition-transform duration-300 ${isVisible ? "translate-y-0" : "translate-y-full"}`}>
